...
sigbm |>
  ...
  #gt::gt(caption = "Dez estados brasileiros com mais barragens cadastradas no SIG-BM") ## para pdf e html
  knitr::kable(caption = "Dez estados brasileiros com mais barragens cadastradas no SIG-BM") # para criar tabelas em word
```
